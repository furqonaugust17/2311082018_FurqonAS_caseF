    ...
    $(document).ready(function() {
            ...
            columns: [
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            let uriEdit = "{{ route('reservasi.edit', ['reservasi' => ':id']) }}"
                                .replace(
                                    ':id', data);
        ...
        function deleteData(id) {
            ...
            if (willDelete) {
                ...
                let uriDelete = "{{ route('reservasi.destroy', ['reservasi' => ':id']) }}".replace(':id', id);
                $.ajaxSetup({
                    headers: {
...
@endsection
<x-layout>
    <x-slot:title>Reservasi</x-slot:title>
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <a class="btn btn-primary mb-3" href="{{route('reservasi.create')}}">Tambah Reservasi</a>
                    <div class="card">
